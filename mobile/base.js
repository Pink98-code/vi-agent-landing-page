...
(function () {
  ...
  const topo = {
    ...
    nodes: {
      ...
      learning: { layer: "delivery", tag: "LRN", name: "Cross-client learning", sub: "patterns · outcomes", detail: "Corrections, keyword outcomes, and recurring cross-client patterns accrue into a pattern registry that later runs read from \u2014 the part of the system that compounds with every client and every operator decision." },
      ...
      decisions: { layer: "delivery", tag: "DEC", name: "Decision capture", sub: "judgment \u2192 memory", detail: "Operator gate decisions are captured and distilled into reusable, generalizable patterns \u2014 proposed for review, never auto-applied \u2014 so human judgment becomes durable institutional memory instead of a one-off click." },
    },
